...
import com.hxxn.ems.adapter.AndroidAdapter;
import com.hxxn.ems.app.Constants;
import com.hxxn.ems.bean.GankIoDataBean;
import com.hxxn.ems.databinding.FragmentCustomBinding;
import com.hxxn.ems.http.RequestImpl;
import com.hxxn.ems.http.cache.ACache;
import com.hxxn.ems.model.GankOtherModel;
import com.hxxn.ems.tools.DebugUtil;
import com.hxxn.ems.tools.SPUtils;
import com.hxxn.ems.tools.ToastUtil;
    ...
    private void initHeader(View mHeaderView) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                new BottomSheet.Builder(getActivity(), R.style.BottomSheet_Dialog).title("选择分类").sheet(R.menu.gank_bottomsheet).listener(new DialogInterface.OnClickListener() {
                    @Override
